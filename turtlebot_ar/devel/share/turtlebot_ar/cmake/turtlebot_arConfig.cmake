...
if("TRUE" STREQUAL "TRUE")
  set(turtlebot_ar_SOURCE_PREFIX /scratch/EE106A/turtlebot_ar/src/turtlebot_ar)
  set(turtlebot_ar_DEVEL_PREFIX /scratch/EE106A/turtlebot_ar/devel)
  ...
  set(turtlebot_ar_INSTALL_PREFIX /scratch/EE106A/turtlebot_ar/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'turtlebot_ar' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/scratch/EE106A/turtlebot_ar/src/turtlebot_ar/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /scratch/EE106A/turtlebot_ar/devel/lib;/scratch/shared/baxter_ws/devel/lib;/opt/ros/kinetic/lib)
